...
# Form implementation generated from reading ui file 'login_senha.ui'
#
...
"border-radius:5px;")
        ...
        self.label_login_string_fazer_login = QtWidgets.QLabel(self.frame)
        self.label_login_string_fazer_login.setGeometry(QtCore.QRect(40, 40, 211, 40))
        self.label_login_string_fazer_login.setMaximumSize(QtCore.QSize(16777215, 40))
        font = QtGui.QFont()
        font.setPointSize(-1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_login_string_fazer_login.setText(_translate("MainWindow", "Olá!"))
        #self.lineEdit_login_cpf.setText(_translate("MainWindow", "Senha"))
        self.lineEdit_login_cpf.setEchoMode(QtWidgets.QLineEdit.PasswordEchoOnEdit)
